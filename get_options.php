        ...
        <div class="space-y-4">
            ...
            if (!empty($process['faqs'])) {
                ...
                foreach ($lines as $line) {
                    ...
                    // If line ends with '?' → it's a question
                    if (substr($line, -1) === '?') {
                        // Print previous FAQ if exists
                        if ($question !== '') {
                            ?>
                            <div class="p-4 bg-gray-50 rounded-lg shadow-sm">
                                <p class="font-bold text-gray-800 mb-2"><?php echo htmlspecialchars($question); ?></p>
                ...
                echo '<p class="text-gray-500">No FAQs available at the moment.</p>';
            }
            ?>
        </div>
    </div>
