...
<nav class="bg-white shadow-md fixed top-0 left-0 w-full z-50">
  <div class="max-w-7xl mx-auto px-4">
    <div class="flex items-center h-16">
      ...
      <div class="hidden md:flex items-center space-x-10">
        ...
        <a href="login.php" class="border border-orange-500 text-orange-500 px-8 py-1 rounded-md hover:bg-orange-500 hover:text-white transition-colors duration-200">Login</a>
      </div>
  ...
  <div id="mobile-menu" class="hidden md:hidden bg-white border-t shadow-lg">
    <div class="px-4 py-4 space-y-3">
      ...
      <a href="login.php" class="inline-block border border-orange-500 text-orange-500 px-8 py-2 rounded-md hover:bg-orange-500 hover:text-white transition-colors duration-200"> Login</a>
    </div>
  </div>
</nav>
