            ...
            <form action="contact.php" method="POST" class="bg-white rounded-xl shadow-sm p-4 sm:p-6 md:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div>
                        ...
                        <input name="name" type="text" id="name" class="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-[#ec8623] rounded-lg focus:ring-2 focus:ring-[#ec8623] outline-none text-sm sm:text-base" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>" required>
                    </div>                   
                    <div>
                        <label for="email" class="block text-gray-700 font-medium text-sm sm:text-base mb-1">Your Email (required)</label>
                        <input name="email" type="email" id="email" class="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-[#ec8623] rounded-lg focus:ring-2 focus:ring-[#ec8623] outline-none text-sm sm:text-base" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>" required>
                    </div>
                </div>                
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div>
                        <label for="phone" class="block text-gray-700 font-medium text-sm sm:text-base mb-1">Your Phone Number</label>
                        <input name="phone" type="tel" id="phone" class="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-[#ec8623] rounded-lg focus:ring-2 focus:ring-[#ec8623] outline-none text-sm sm:text-base" value="<?php echo isset($_POST['phone']) ? htmlspecialchars($_POST['phone']) : ''; ?>">
                    </div>                    
                    <div>
                        <label for="subject" class="block text-gray-700 font-medium text-sm sm:text-base mb-1">Subject</label>
                        <input name="subject" type="text" id="subject" class="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-[#ec8623] rounded-lg focus:ring-2 focus:ring-[#ec8623] outline-none text-sm sm:text-base" value="<?php echo isset($_POST['subject']) ? htmlspecialchars($_POST['subject']) : ''; ?>">
                    </div>
                </div>                
                <div class="mb-6 sm:mb-8">
                    <label for="message" class="block text-gray-700 font-medium text-sm sm:text-base mb-1">Your Message (required)</label>
                    <textarea name="message" id="message" rows="4" class="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-[#ec8623] rounded-lg focus:ring-2 focus:ring-[#ec8623] outline-none text-sm sm:text-base" required><?php echo isset($_POST['message']) ? htmlspecialchars($_POST['message']) : ''; ?></textarea>
                </div>                
                <div class="flex justify-center">
                    <button type="submit" name="submit" class="px-6 sm:px-8 md:px-[45px] bg-[#ec8623] text-white py-2.5 sm:py-3 rounded-lg hover:bg-[#f79739] transition duration-300 flex items-center justify-center text-sm sm:text-base w-full sm:w-auto">
        ...
        <div class="mt-12 sm:mt-16 mb-8 sm:mb-10 px-0 sm:px-4 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div class="bg-white p-4 sm:p-5 rounded-lg shadow-md flex flex-col justify-between hover:shadow-lg transition duration-300">
                    <div>
                        <div class="w-full h-32 sm:h-36 md:h-40 bg-gradient-to-r from-orange-100 to-pink-100 rounded-lg overflow-hidden">
                            <img src="./assets/images/Sangli.png" alt="Sangli Office" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                        </div>
                    ...
                    <a href="https://www.google.com/maps?q=F14, 3rd Floor, Shri Kapila, MSEB Road, Vishrambagh, Sangli" target="_blank" rel="noopener noreferrer" class="mt-3 sm:mt-4 px-4 py-2 bg-[#ec8623] text-white rounded-lg hover:bg-[#f79739] transition duration-300 flex items-center justify-center text-sm sm:text-base">
                ...
                <div class="bg-white p-4 sm:p-5 rounded-lg shadow-md flex flex-col justify-between hover:shadow-lg transition duration-300">
                    <div>
                        <div class="w-full h-32 sm:h-36 md:h-40 bg-gradient-to-r from-orange-100 to-pink-100 rounded-lg overflow-hidden">
                            <img src="./assets/images/Karad.png" alt="Karad Office" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                        </div>
                        <div class="mt-3 sm:mt-4">
                    ...
                    <a href="https://www.google.com/maps?q=Flat No. 2, Suman Appt, Near Hotel Deviprasad, Opposite to Gov Pharmacy College, Vidyanagar, Karad" target="_blank" rel="noopener noreferrer" class="mt-3 sm:mt-4 px-4 py-2 bg-[#ec8623] text-white rounded-lg hover:bg-[#f79739] transition duration-300 flex items-center justify-center text-sm sm:text-base">
                        <i class="fas fa-map-marker-alt mr-2"></i> View Map
                    </a>
                </div>   
                <!-- Kolhapur -->
                <div class="bg-white p-4 sm:p-5 rounded-lg shadow-md flex flex-col justify-between hover:shadow-lg transition duration-300">
                    <div>
                        <div class="w-full h-32 sm:h-36 md:h-40 bg-gradient-to-r from-orange-100 to-pink-100 rounded-lg overflow-hidden">
                            <img src="./assets/images/Kolhapur.png" alt="Kolhapur Office" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                        </div>
                        <div class="mt-3 sm:mt-4">
                    ...
                    <a href="https://www.google.com/maps?q=RS No.2107/K 6th Lane, Rajarampuri, Kolhapur" target="_blank" rel="noopener noreferrer" class="mt-3 sm:mt-4 px-4 py-2 bg-[#ec8623] text-white rounded-lg hover:bg-[#f79739] transition duration-300 flex items-center justify-center text-sm sm:text-base">
                        <i class="fas fa-map-marker-alt mr-2"></i> View Map
                    </a>
                </div>                
                <!-- Satara -->
                <div class="bg-white p-4 sm:p-5 rounded-lg shadow-md flex flex-col justify-between hover:shadow-lg transition duration-300">
                    <div>
                        <div class="w-full h-32 sm:h-36 md:h-40 bg-gradient-to-r from-orange-100 to-pink-100 rounded-lg overflow-hidden">
                            <img src="./assets/images/Satara.png" alt="Satara Office" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                        </div>
                        <div class="mt-3 sm:mt-4">
